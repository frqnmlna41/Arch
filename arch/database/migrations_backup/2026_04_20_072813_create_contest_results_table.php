...
return new class extends Migration
{
    /**
     * Run the migrations.
     * Migration: 2024_01_01_000013_create_contest_results_table
     *
     * Command: php artisan make:migration create_contest_results_table
     *
    ...
    public function up(): void
    {
        Schema::create('contest_results', function (Blueprint $table) {
            ...
            $table->foreignId('contest_id')
                ->unique() // Satu contest hanya punya satu result
                ->constrained('contest')
                ->cascadeOnDelete();
