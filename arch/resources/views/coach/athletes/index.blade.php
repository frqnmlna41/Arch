    ...
    @section('content')
        ...
        ══════════════════════════════════════ --}}
            <div class="ath-header">
                ...
                <div class="ath-header__right">
                    <a href="{{ route('coach.athletes.create') }}" class="ath-btn ath-btn--primary">
        ...
        ══════════════════════════════════════ --}}
            <div class="ath-filter-card">
                <form method="GET" action="{{ route('coach.athletes.index') }}" class="ath-filter-form" id="filterForm">
                                ...
                                <tr class="ath-table__row">
                                    ...
                                    <td class="ath-table__td ath-table__td--center">
                                        <div class="ath-actions">
                                            <a href="{{ route('coach.athletes.show', $athlete) }}"
                                            ...
                                            <a href="{{ route('coach.athletes.edit', $athlete) }}"
                                ...
                                <tr>
                                    <td colspan="9" class="ath-table__empty">
                                        <div class="ath-empty-state">
                                            ...
                                            <a href="{{ route('coach.athletes.create') }}"
