                    ...
                    <div class="inv-detail-card__body">
                        <div class="inv-coach-info">
                            <div class="inv-coach-avatar">
                                {{ strtoupper(substr($invoice->coach->name, 0, 2)) }}
                            </div>
                            <div>
                                <div class="inv-coach-name">{{ $invoice->coach->name }}</div>
                                <div class="inv-coach-email">{{ $invoice->coach->email }}</div>
                            </div>
                        </div>
                        <div class="inv-meta-grid">
                            ...
                            <div class="inv-meta-item">
                                ...
                                @endphp
                                <span
                                    class="inv-meta-value {{ $isOverdue ? 'inv-meta-value--danger' : '' }}">{{ $invoice->due_date->format('d M Y') }}
                                    @if ($isOverdue)
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <div class="inv-event-cell">
                                                <span
                                                    class="inv-event-name">{{ $item->eventCategory->event->name ?? '—' }}</span>
                                                @if ($item->eventCategory->ageCategory)
                                                    <span
                                                        class="inv-age-badge">{{ $item->eventCategory->ageCategory->name }}</span>
                                                @endif
                                            </div>
                                        </td>
                                        <td>
