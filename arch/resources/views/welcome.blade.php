...
@section('content')
    ...
    <div class="container mx-auto px-4 py-30">
        <div class="flex flex-col md:flex-row items-center justify-center gap-25">
            <img src="{{ Vite::asset('resources/assets/Maskot_1.png') }}" alt="Maskot 1"
                class="hidden md:block w-32 md:w-40 h-auto object-contain" />
            <div>
                <h1 class="text-3xl font-bold text-center">Selamat Datang di Q Square Martial Arts Competition</h1>
                <p class="text-center text-base-content mt-4">Bergabunglah dengan turnamen bela diri yang menantang dan
                    menarik!</p>
                <div class="flex justify-center mt-6">
                    <a href="https://drive.google.com/file/d/10Rfv201iddVEF4PcIix78ob-pTivJjP1/view?usp=drivesdk"
                        class="btn btn-warning btn-lg text-white shadow-sm hover:shadow-lg">Unduh Juklak Pertandingan</a>
                </div>
            </div>
            <img src="{{ Vite::asset('resources/assets/Maskot_3.png') }}" alt="Maskot 3"
                class="w-32 md:w-40 h-auto object-contain" />
        </div>
        ...
        <div class="bg-gradient-to-r from-blue-400 to-blue-700 rounded-xl shadow-xl p-6 mt-16">
            ...
            <div class="flex flex-1 justify-end mt-6">
                <a href="#" class="link text-sm/6 font-semibold text-white">Lihat Semua <span
