    ...
    <div class="ath-page">
        ...
        <div class="ath-header">
            ...
            <div class="ath-header__right">
                <a href="{{ route('admin.athletes.edit', $athlete) }}" class="ath-btn ath-btn--primary">
                ...
                <a href="{{ route('admin.athletes.index') }}" class="ath-btn ath-btn--ghost">
                    <svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor"
                        stroke-width="2.5">
                ...
                <div class="ath-show-profile__body">
                    ...
                    <div class="ath-show-grid">
                        <div class="ath-show-field">
                            ...
                            <span class="ath-show-field__value">{{ $athlete->club ?? '—' }}</span>
                        </div>
                        <div class="ath-show-field">
                        ...
                        <div class="ath-show-field">
                            ...
                            <span class="ath-show-field__value">{{ $athlete->ageRangeLabel ?? '—' }}</span>
                        </div>
                        <div class="ath-show-field">
        ...
        <div class="ath-table-card">
            <div class="ath-table-header">
                <span>
                    Event Participation
                    <span class="ath-badge">{{ $athlete->eventParticipants->count() }}</span>
                </span>
            </div>
            <div class="ath-table-wrap">
                <table class="ath-table">
                    ...
                    <tbody>
                        @forelse($athlete->eventParticipants as $i => $ep)
                            <tr class="ath-table__row">
                                <td class="ath-table__td ath-table__td--num">{{ $i + 1 }}</td>
                                <td class="ath-table__td">{{ $ep->eventCategory->event->name ?? '-' }}</td>
                                <td class="ath-table__td">{{ $ep->eventCategory->discipline->name ?? '-' }}</td>
