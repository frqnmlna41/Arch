            ...
            <aside class="w-64 bg-white flex flex-col min-h-screen">
                ...
                <nav class="flex-1 overflow-y-auto py-4 text-sm">
                    ...
                    <div class="px-4 space-y-1">
                        ...
                        <x-sidebar-link route="coach.dashboard" icon="tachometer-alt">
                            Dashboard
                        </x-sidebar-link>

                        <p class="mt-6 mb-2 text-xs text-gray-400 uppercase">Master</p>

                        <x-sidebar-link route="coach.invoices.*" icon="file-invoice">
                            Keuangan
                        </x-sidebar-link>

                        {{-- <x-sidebar-link route="coach.sports.*" icon="trophy">
                            Olahraga
                        </x-sidebar-link> --}}

                        {{-- <x-sidebar-link route="coach.disciplines.*" icon="gavel">
                            Disiplin
                        </x-sidebar-link> --}}

                        {{-- <x-sidebar-link route="coach.age-categories.*" icon="users">
                            Kategori Umur
                        </x-sidebar-link> --}}

                        {{-- <x-sidebar-link route="coach.arenas.*" icon="map-marker-alt">
                            Arena
                        </x-sidebar-link> --}}

                        {{-- <p class="mt-6 mb-2 text-xs text-gray-400 uppercase">Event</p>

                        <x-sidebar-link route="coach.events.*" icon="calendar">
                            Event
                        </x-sidebar-link> --}}

                        <x-sidebar-link route="coach.matches.*" icon="fist-raised">
                            Pertandingan
                        </x-sidebar-link>

                        <p class="mt-6 mb-2 text-xs text-gray-400 uppercase">User</p>

                        <x-sidebar-link route="coach.athletes.*" icon="user-friends">
                            Atlet
                        </x-sidebar-link>

                        <p class="mt-6 mb-2 text-xs text-gray-400 uppercase">Invoice</p>
                        ...
                        <x-sidebar-link route="coach.winners.*" icon="medal">
                            Pemenang
                        </x-sidebar-link>

                        <x-sidebar-link route="coach.certificates.*" icon="certificate">
                            Sertifikat
                        </x-sidebar-link>
